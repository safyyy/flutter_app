...
import 'package:citoyen/components/mail_input_field.dart';
import 'package:citoyen/components/rounded_button.dart';
import 'package:citoyen/components/rounded_input_field.dart';
import 'package:citoyen/components/rounded_password_field.dart';
...
class _BodyState extends State<Body> {
  ...
  loginPressed() async {
       ...
       if(_password.text.trim().isEmpty){
          ...
          AuthServices.userLogin(data).then((value) {
            if(value!=0&&value!=9){
              ...
              Navigator.push(context, 
              MaterialPageRoute(
                builder: (BuildContext context) => AuthLog()));
              }
            }else{
              setState(() {
                isLoader = true;
    ...
    return Scaffold(body: BackgroundLogin(
      child: 
      SingleChildScrollView(
        ...
        key: formKey,
          child: Column(
            ...
            children: <Widget>[Text("LOGIN", style: TextStyle(fontWeight:FontWeight.bold),
            ),
            SizedBox(
          ...
          child: FlatButton(
            ...
            onPressed: () { 
              ...
              if(isValidForm){
                loginPressed();
//  Navigator.push(context, 
//             MaterialPageRoute(builder: (context){return AuthLog();
//            },
//           ),
//            );
              }
